...
- Go 1.26.1 + chi v5 (HTTP), pgx/v5 + sqlc (DB), zap (logging), (019-preserve-mime-on-edit)
- PostgreSQL `file` table (shared Alkemio DB, full CRUD owned here per (019-preserve-mime-on-edit)
